                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        ...
                        <?php       
                            if (isset($_POST['user_signup_submit'])) {
                                ...
                                if($fname == "" || $lname == "" || $gender == "" || $email == "" || $contact == "" || $password == "" || $cpassword == ""){
                                    echo "<script>swal({
                                    ...
                                    if ($password == $cpassword) {
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            $sql = "INSERT INTO patient (fname,lname,gender,email,contact,password,cpassword) VALUES ('$fname', '$lname', '$gender', '$email', '$contact', '$password', '$cpassword')";
                                            $result = mysqli_query($conn, $sql);
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <form class="user_signup" id="usersignup" method="post" action="">
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="user_signup_submit" onclick="return checklen();" value="Register"/>
                                    </div>
                            ...
                            <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="login_admin" value="Login"/>
                                    </div>
                                </div>
                            </form>
                            </div>
